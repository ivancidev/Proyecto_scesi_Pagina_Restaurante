...
export const getPostFavorites = (key) => `${API_BASE_URL}/favoritesOrders/${key}`;
export const getPostDeleteFavorite = (key) => `${API_BASE_URL}/deleteFavorite/${key}`;
...
export const createNewPostFavorite = () => `${API_BASE_URL}/addFavorite`;
